...
namespace CurrencyConverter
{
    public class Manipulation
    {
        ...
        public virtual Dictionary<string, double> TenMostStable(Dictionary<string, double> dictionary)
        {
            Dictionary<string, double> sortedDictionary = SortDictionary(dictionary);
